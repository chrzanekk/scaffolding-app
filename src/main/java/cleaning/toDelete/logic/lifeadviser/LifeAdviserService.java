package cleaning.toDelete.logic.lifeadviser;
...
import cleaning.toDelete.logic.UsersService;
import cleaning.toDelete.logic.adviser.AccountsService;
import cleaning.toDelete.logic.adviser.AdviceCategoriesService;
import cleaning.toDelete.logic.adviser.AdviserService;
import cleaning.toDelete.logic.courseplatform.EmailUtil;
...
//    }
    ...
    public Long startPurchase(String userId, Long categoryId, String applicationId,
        ...
        Long id = adviceCategoriesService.storePurchase(new AdvisePurchaseData(userId, category.getId(), applicationId, domain, startDate, calculateEndDate(startDate, periodType), choosePrice(category, periodType), category.getCurrencyCode(), user.getAccount().getId(), periodType));
        return id;
    }
