...
import cleaning.toDelete.domain.courseplatform.CustomerAuthoritiesFilter;
import cleaning.toDelete.domain.courseplatform.CustomerAuthorityData;
...
public class CustomerAuthoritiesService {
    ...
    //nazwa ? to też służy do innych ról
