...
//import pl.com.chrzanowski.scaffolding.domain.InvoiceData;
//import pl.com.chrzanowski.scaffolding.domain.courseplatform.*;
//import pl.com.chrzanowski.scaffolding.logic.courseplatform.*;
//import pl.com.chrzanowski.scaffolding.logic.courseplatform.notifications.NotificationType;
//import pl.com.chrzanowski.scaffolding.logic.courseplatform.notifications.NotificationsService;
//
...
//        CustomerData customerCreateRequest = new CustomerData(request.getLogin(), request.getPasswordHash(), request.getLanguage(), request.getRegulationAccepted(), request.getNewsletterAccepted(), request.getIsEnabled(), request.getIsEmailConfirmed(), httpServletRequest);
...
//                request.getRegulationAccepted(), request.getNewsletterAccepted(), request.getAuthorFirstName(), request.getAuthorLastName(), httpServletRequest);
