package cleaning.toDelete.domain.courseplatform;
...
public class CustomerData {
    ...
    public CustomerData(String login, String passwordHash, String language, Boolean regulationAccepted, Boolean newsletterAccepted, String invoiceFirstAndLastName, Boolean isEnabled, Boolean emailConfirmed, String[] authorities, HttpServletRequest httpServletRequest) {
        this.login = login;
        this.passwordHash = passwordHash;
        this.language = language;
        this.regulationAccepted = regulationAccepted;
    ...
    public CustomerData(Long id, String login, String passwordHash, String language, String invoiceType, String invoiceCompanyName, String invoiceStreet, String invoicePostalCode, String invoiceCity, String invoiceNip, String invoiceCountry, Boolean regulationAccepted, Boolean newsletterAccepted, String invoiceFirstAndLastName, Boolean isEnabled, Boolean emailConfirmed, LocalDateTime registrationDatetime, String[] authorities) {
        this.id = id;
        this.login = login;
        this.passwordHash = passwordHash;
        this.language = language;
    ...
    public CustomerData(String login, String passwordHash, String language, Boolean regulationAccepted, Boolean newsletterAccepted, Boolean isEnabled, Boolean emailConfirmed, HttpServletRequest httpServletRequest) {
        this.login = login;
        this.passwordHash = passwordHash;
        this.language = language;
        this.regulationAccepted = regulationAccepted;
    ...
    public CustomerData(String login, String passwordHash, String language, Boolean regulationAccepted, Boolean newsletterAccepted, String authorFirstName, String authorLastName, HttpServletRequest httpServletRequest) {
        this.login = login;
        this.passwordHash = passwordHash;
        this.language = language;
        this.regulationAccepted = regulationAccepted;
    ...
    public CustomerData(CustomerData data, String[] authorities) {
        this.id = data.getId();
        this.login = data.getLogin();
