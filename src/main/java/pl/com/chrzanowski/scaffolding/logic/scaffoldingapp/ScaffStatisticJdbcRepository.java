...
public class ScaffStatisticJdbcRepository {
    ...
    private static final Logger log = LoggerFactory.getLogger(ScaffStatisticJdbcRepository.class);
    private JdbcTemplate jdbcTemplate;


    public ScaffStatisticJdbcRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;

    }

//    StatisticData refresh(ScaffStatisticType type, String param, Integer number) {
...
//    }
    ...
    List<StatisticItemCountData> findVisitedLandings() {
        String query = "SELECT value, count(*) as c FROM action_trace WHERE what = 'page.show' and value LIKE " +
                "'%landing%' group by value order by c DESC";
        List<Map<String, Object>> rows = jdbcTemplate.queryForList(query);
...
//    private StatisticData getStatistic(ScaffStatisticType type, String param, Integer value) {
//        if (type.equals(ScaffStatisticType.NUMBER_OF_VISIBLE_COURSES)) {
...
//        } else if (type.equals(ScaffStatisticType.NUMBER_OF_NO_FREE_ORDERS)) {
//            return new StatisticData(type, getNumberOfNoFreeOrders(param));
//        } else if (type.equals(ScaffStatisticType.NUMBER_OF_FREE_ORDERS)) {
//            return new StatisticData(type, getNumberOfFreeOrders(param));
//        } else if (type.equals(ScaffStatisticType.REGISTERED_CUSTOMERS_IN_LAST)) {
