...
public class ScaffNotificationsValidator {
    ...
    public void validate(ScaffNotificationData notification) {
        validateIfNull(notification);
        validateCustomer(notification.getUser());
    ...
    public void validateIfNull(ScaffNotificationData notification) {
        if (notification == null) {
            throw new IllegalArgumentException("Notification can't be null");
        }
    }

    public void validateCustomer(ScaffUserData user) {
        if (user == null) {
