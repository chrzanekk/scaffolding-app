...
import pl.com.chrzanowski.scaffolding.domain.scaffoldingapp.CreateNotificationsParameters;
...
public class NotificationsFromPanelService {
    ...
    public NotificationsFromPanelService(UsersService usersService, NotificationsService notificationsService,
    ...
    public void createNotifications(CreateNotificationsParameters parameters) {
        ...
        List<UserData> customers = usersService.find(new UsersFilter(parameters.getLanguage()));
