...
import pl.com.chrzanowski.scaffolding.domain.scaffoldingapp.NotificationsFilter;
...
public class NotificationsJdbcRepository {
    ...
    public NotificationsJdbcRepository(JdbcTemplate jdbcTemplate, UsersService usersService) {
    ...
    Long unseenNotificationsCount(UserData customer) {
